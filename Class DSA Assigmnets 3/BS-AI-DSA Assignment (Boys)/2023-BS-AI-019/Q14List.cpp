...
// Function to take a ticket (add to the end of the queue)
...
// Function to serve a ticket (remove from the front of the queue)
void serveTicket(list<int>& Ticket) 
{
    ...
    {
        int servedTicket = Ticket.front(); // Get the ticket at the front
        Ticket.pop_front(); // Remove the ticket from the front
